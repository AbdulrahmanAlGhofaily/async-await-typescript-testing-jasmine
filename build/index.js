...
function getCountry(countryName) {
    return __awaiter(this, void 0, void 0, function () {
        var getApi, data, capital, region, numericCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.com/v2/name/".concat(countryName))];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data[0];
                    capital = data.capital, region = data.region, numericCode = data.numericCode;
                    return [2 /*return*/, { capital: capital, region: region, numericCode: numericCode }];
            }
        });
    });
}
...
function getRegionCountries(regionalbloc) {
    return __awaiter(this, void 0, void 0, function () {
        var getApi, data, countries, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.com/v2/regionalbloc/".concat(regionalbloc))];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    countries = [];
...
exports.default = {
    ...
    getRegionCapitals: getRegionCapitals,
};
